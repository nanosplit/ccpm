...
echo "  /pm:start-feature <name> - End-to-end: PRD → epic → tasks → implement"
echo "  /pm:work-on <task>       - Research, plan, implement, and test a task"
echo "  /pm:autopilot <epic>     - Unattended: run all tasks, push, create PR"
echo "  /pm:review               - Review current branch for bugs and merge readiness"
